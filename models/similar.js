...
async function getAllSimilarGames(start = 0, limit = 50, gameid) {
    ...
    const [rows] = await db.execute(
        ...
        g2.category similar_game_category, g2.summary similar_game_summary, gc.url as similar_game_cover from games g 
        inner join game_similar gs on gs.game_id = g.game_id
        inner join games g2 on g2.game_id = gs.similar_game_id 
        inner join game_covers gc on gc.game_id = g2.game_id
        ${condition} Limit ?,?`,
        [
